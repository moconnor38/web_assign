...
namespace SampleTemplate.Controllers
{
    public class GamesController : Controller
    {
        ...
        public ActionResult Index()
        {
           ...
           List<Game> gamelist = dao.ShowAllGames();
      //      {
      ...
      //          new Game { Developer = "Bungie", Title = "Destiny2", DatePublished = new DateTime(2017, 10, 24), Genre = "Action", Publisher = "Activision", /*Price=49.99m*/GameImage = "Destiny2.jpg" },
      ...
      //      };
        ...
        {           
            List<Game> genreList = dao.ShowAllGames();

            var list = from g in genreList
                       where g.Genre == genre
                       select g;
